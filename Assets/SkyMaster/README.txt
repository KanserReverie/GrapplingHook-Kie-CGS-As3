...
IMPORTANT: For the InfiniCLOUD URP version, erase all imported assets beside the
"InfiniCLOUD URP v1.5.9 - Please erase all InfiniCLOUD HDRP assets before Import"
unity package inside the "ARTnGAME" -> "InfiniCLOUD URP" folder and install this
package to access the URP native version of InfiniCLOUD.
